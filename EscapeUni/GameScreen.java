...
public class GameScreen implements Screen {
    ...
    * Add and hide light circles for player and goose
    ...
    private void initialiseItems() {
        ...
        items.put("airhorn", new Collectable(game, "items/airhorn.png", 300, 100, 0.1f, true, "GameScreen", audioManager));
    }
    ...
    private void initialiseDean2(float x, float y) {
        dean2 = new Dean("sprites/dean2.png", x, y, collisionLayer, mapWallsId, tileDimensions);
    }
    ...
    private void update(float delta) {
        ...
        if(!isPaused && !busLeaving) {
            ...
            if (dean2 != null) {
                dean2.update(stateTime, delta, player, healthSystem);
            }
        ...
        for(String key:items.keySet()) {
            ...
            if (item.playerHas){
                ...
                if (key.startsWith("healthBoost")) {
                    instructions = "Press 'e' to heal your health";
                }
                else if (key.startsWith("shield")) {
